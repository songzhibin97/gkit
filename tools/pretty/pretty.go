...
func Pretty(json []byte) []byte { return BestOptions(json, nil) }

// BestOptions is like Pretty but with customized options.
func BestOptions(json []byte, opts *Options) []byte {
	if opts == nil {
		opts = DefaultOptions
	}
