...
// AllowFunc: 实现 Allower 接口
type AllowFunc func(now time.Time, n int64) bool

func (a AllowFunc) Allow() bool {
	return a.AllowN(time.Now(), 1)
}

func (a AllowFunc) AllowN(now time.Time, n int64) bool {
	return a(now, n)
}

// WaitFunc: 实现 Waiter 接口
type WaitFunc func(ctx context.Context, n int64) error

func (w WaitFunc) Wait(ctx context.Context) error {
	return w.WaitN(ctx, 1)
}

func (w WaitFunc) WaitN(ctx context.Context, n int64) error {
	return w(ctx, n)
}
